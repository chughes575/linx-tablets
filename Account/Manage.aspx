<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="linx_tablets.Account.Manage" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 download-page">
                <h2 class="h2-help">Account management</h2>
